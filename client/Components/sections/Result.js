    ...
    render: function () {
        if (this.props.resultArticles && this.props.resultArticles.length === 0) {
            ...
            if (this.props.resultArticles !== undefined) {
                    ...
                    return (
                        <li className="list-group-item" key={i}>
                            ...
                            <div className="text-right">
                                <a href={article.link} target="_blank"> <button type="button" className="btn btn-info btn-sm mini-button">View</button> </a>
                ...
                var articles = <div className="text-center"> Sorry, no results available.</div>;
            }
        }
        return (
            <div className="col-md-12">
